...
(function(f){f.extend(mejs.MepDefaults,{googleAnalyticsTitle:"",googleAnalyticsCategory:"Videos",googleAnalyticsEventPlay:"Play",googleAnalyticsEventPause:"Pause",googleAnalyticsEventEnded:"Ended",googleAnalyticsEventTime:"Time"});f.extend(MediaElementPlayer.prototype,{buildgoogleanalytics:function(a,b,c,d){d.addEventListener("play",function(){if(typeof _gaq!="undefined")_gaq.push(["_trackEvent",a.options.googleAnalyticsCategory,a.options.googleAnalyticsEventPlay,a.options.googleAnalyticsTitle===
""?a.currentSrc:a.options.googleAnalyticsTitle])},false);d.addEventListener("pause",function(){if(typeof _gaq!="undefined")_gaq.push(["_trackEvent",a.options.googleAnalyticsCategory,a.options.googleAnalyticsEventPause,a.options.googleAnalyticsTitle===""?a.currentSrc:a.options.googleAnalyticsTitle])},false);d.addEventListener("ended",function(){if(typeof _gaq!="undefined")_gaq.push(["_trackEvent",a.options.googleAnalyticsCategory,a.options.googleAnalyticsEventEnded,a.options.googleAnalyticsTitle===
""?a.currentSrc:a.options.googleAnalyticsTitle])},false)}})})(mejs.$);
